...
def check_http():
    ...
    cases = [
        ...
        ("/guias/me-reservo-el-derecho-en-el-finiquito", 200, "html"),
        ...
        ("/viatico", 200, "html"),
        ("/sueldo-empresarial", 200, "html"),
        ("/franquicia-sence", 200, "html"),
        ("/reajuste-ipc", 200, "html"),
        ("/reajuste", 404, None),
        ("/reajuste-sueldo", 404, None),
        ("/reajuste-salarial", 404, None),
        ("/ipc", 404, None),
        ("/calculadora-ipc", 404, None),
        ("/ipc-acumulado", 404, None),
        ("/inflacion", 404, None),
        ("/actualizacion-sueldo", 404, None),
        ("/reajuste-por-ipc", 404, None),
        ("/utm", 404, None),
        ("/uf", 404, None),
        ("/franquicia-tributaria", 404, None),
        ("/impulsa-personas", 404, None),
        ("/sence", 404, None),
        ("/1-porciento-sence", 404, None),
        ("/capacitacion-sence", 404, None),
        ("/franquicia-capacitacion", 404, None),
        ("/aporte-sence", 404, None),
        ("/otic", 404, None),
        ("/valor-hora-sence", 404, None),
        ("/sueldo-patronal", 404, None),
        ("/retiro-empresarial", 404, None),
        ("/sueldo-del-socio", 404, None),
        ("/remuneracion-empresarial", 404, None),
        ("/gasto-sueldo-empresarial", 404, None),
        ("/sueldo-empresarial-sii", 404, None),
        ("/tope-sueldo-empresarial", 404, None),
        ("/viaticos", 404, None),
        ("/viatico-chile", 404, None),
        ("/asignacion-viatico", 404, None),
        ("/gastos-de-viaje", 404, None),
        ("/tabla-viaticos", 404, None),
        ("/viatico-sii", 404, None),
        ("/viatico-funcionario", 404, None),
        ("/viatico-municipal", 404, None),
        ("/per-diem", 404, None),
        ...
        ("/apv", 200, "html"),
        ("/sala-cuna", 200, "html"),
        ("/inclusion-laboral", 200, "html"),
        ("/jornada-parcial", 200, "html"),
        ("/teletrabajo", 200, "html"),
        ("/bandas-horarias", 200, "html"),
        ("/pacto-4x3", 200, "html"),
        ("/jornada-excepcional", 200, "html"),
        ("/jornada-bisemanal", 200, "html"),
        ("/compensacion-horas-extras", 200, "html"),
        ("/pacto-horas-extras", 200, "html"),
        ("/pacto-he", 404, None),
        ("/acuerdo-horas-extras", 404, None),
        ("/horas-extraordinarias-pacto", 404, None),
        ("/art-31", 404, None),
        ("/limite-horas-extras", 404, None),
        ("/maximo-horas-extras", 404, None),
        ("/contrato-plazo-fijo", 200, "html"),
        ("/termino-anticipado-plazo-fijo", 200, "html"),
        ("/permiso-sin-goce", 200, "html"),
        ("/zona-extrema", 200, "html"),
        ("/promedio-remuneraciones", 200, "html"),
        ("/antiguedad-laboral", 200, "html"),
        ("/tope-imponible", 200, "html"),
        ("/tope", 404, None),
        ("/topes", 404, None),
        ("/tope-afp", 404, None),
        ("/tope-salud", 404, None),
        ("/tope-uf", 404, None),
        ("/tope-previsional", 404, None),
        ("/renta-imponible", 404, None),
        ("/base-imponible", 404, None),
        ("/uf-tope", 404, None),
        ("/calcular-tope", 404, None),
        ("/cotizaciones", 404, None),
        ("/sueldo-imponible", 404, None),
        ("/antiguedad", 404, None),
        ("/anos-servicio", 404, None),
        ("/anos-de-servicio", 404, None),
        ("/calcular-antiguedad", 404, None),
        ("/tiempo-servicios", 404, None),
        ("/aniversario-laboral", 404, None),
        ("/antiguedad-ias", 404, None),
        ("/anos-ias", 404, None),
        ("/comisiones", 404, None),
        ("/comision-variable", 404, None),
        ("/promedio-comisiones", 404, None),
        ("/remuneraciones-variables", 404, None),
        ("/ultima-remuneracion", 404, None),
        ("/art-172", 404, None),
        ("/base-indemnizacion", 404, None),
        ("/promedio-3-meses", 404, None),
        ("/postnatal-parental", 200, "html"),
        ("/permiso-prenatal", 200, "html"),
        ("/nulidad-despido", 200, "html"),
        ("/fuero-maternal", 200, "html"),
        ("/autodespido", 200, "html"),
        ("/obra-faena", 200, "html"),
        ("/prescripcion-laboral", 200, "html"),
        ("/descanso-compensatorio", 200, "html"),
        ("/permiso-paternidad", 200, "html"),
        ("/permiso-matrimonio", 200, "html"),
        ("/permiso-fallecimiento", 200, "html"),
        ("/interes-mora", 200, "html"),
        ("/hora-lactancia", 200, "html"),
...
PAGES = [
    ...
    ("guias/me-reservo-el-derecho-en-el-finiquito.html", "guia-me-reservo-el-derecho"),
]
