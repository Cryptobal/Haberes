  ...
  }
  {
    ...
    assert(
      ...
      /\/fuero-maternal/.test(readFileSync(join(root, "docs/seo-map.md"), "utf8")) &&
        /no canibalizar `\/postnatal-parental`, `\/sala-cuna`, `\/hora-lactancia`, `\/permiso-paternidad`/.test(
          readFileSync(join(root, "docs/seo-map.md"), "utf8"),
        ) &&
